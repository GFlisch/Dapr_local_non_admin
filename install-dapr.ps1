...
if ($args.Length -eq 0)  {
    ...
    Write-Host "Optionaly you can provide where to install the daprd executable, default is C:\Prj folder"
    exit
}
...
if ($args.Length -eq 2)  {
    ...
    Write-Host "Dapr folder used will be " + $Dapr_Version -foregroundColor Red -BackGroundColor Black
    exit
}
